                    ...
                    pageCarousels: [
                        {
                            ...
                            carouselItens: [
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                            <h2><strong style="font-size:inherit;">ANTES DA LEITURA</strong></h2>\
                                            <h3 style="margin-left:20px;"><span style="font-size:inherit;">Prepare-se para apresentar o livro. Observe a capa:</span></h3>\
                                            <ul style="margin-left:25px;">\
                                                <li><div class="circle"></div><p>Quem é autora do texto?</p></li>\
                                                <li><div class="circle"></div><p>Quem realizou as ilustrações?</p></li>\
                                                <li><div class="circle"></div><p>Leia as duas páginas finais do livro. Ali você vai ficar sabendo muito sobre a origem da história que vai ler, sobre Ruth Rocha e a ilustradora.</p></li>\
                                            </ul>\
                                        </div>\
                                    </div>',
                                    itemNavigation: {
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                            <h2><strong style="font-size:inherit;">ANTES DA LEITURA</strong></h2>\
                                            <h3 style="margin-left:20px;"><span style="font-size:inherit;">Converse com seus alunos:</span></h3>\
                                            <ul style="margin-left:30px;">\
                                                <li><div></div><p>Será que eles já conhecem Ruth Rocha? Já leram algum livro dela?</p></li>\
                                                <li><div></div><p>Onde está nome da autora? Com que tipo de letra ele está impresso? Por que vocês acham que ele foi impresso assim?</p></li>\
                                                <li><div></div><p>Onde está o nome da ilustradora? Por que vocês acham que ele aparece também na capa?</p></li>\
                                                <li><div></div><p>Onde está o logotipo da editora?</p></li>\
                                                <li><div></div><p>Que imagem aparece na capa? Quem ela representa? Por que será que ela está usando uma coroa? Por que tem um olho fechado? Ela é uma princesa ou uma boneca?</p></li>\
                                            </ul>\
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                            <h2><strong style="font-size:inherit;">ANTES DA LEITURA</strong></h2>\
                                            <h3 style="margin-left:20px;"><span style="font-size:inherit;">Observe a quarta capa do livro.</span></h3>\
                                            <ul style="margin-left:30px;">\
                                                <li><div></div><p>Leia o texto em voz alta. Ele é um texto que você pode ler para seus alunos – ou pedir a algum deles que leia, não? Pode ser uma forma de motivá-los para a leitura.</p></li>\
                                                <li><div></div><p>Observe também que o livro pertence a uma série: Série Vou Te Contar!, sobre a qual há mais informações na página 39 do livro, que você já leu.  Alguém conhece outros livros da série?</p></li>\
                                                <li><div></div><p>Observe a ilustração da quarta capa: uma menina brincando e, ao seu lado, uma boneca velha. Será que a história é sobre a menina ou sobre a boneca? Pergunte isso a seus alunos e espere que eles façam antecipações sobre o que vão ler.</p></li>\
                                                <li><div></div><p>Aponte o nome da editora.</p></li>\
                                                <li><div></div><p>Que imagem aparece na capa? Quem ela representa? Por que será que ela está usando uma coroa? Por que tem um olho fechado? Ela é uma princesa ou uma boneca?</p></li>\
                                            </ul>\
                                            \
                                        </div>\
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                            <h2><strong style="font-size:inherit;">ANTES DA LEITURA</strong></h2>\
                                            <h4 style="margin-left:20px;"><span style="font-size:inherit;">Observe (e ajude seus alunos a observar) o verso da capa e a primeira página do livro.</span></h4>\
                                            <ul style="margin-left:30px;">\
                                                <li><div></div><p>A ilustradora fez uma brincadeira, misturando contos de fadas diferentes.</p></li>\
                                                <li><div></div><p>Pergunte a seus alunos: eles conseguem perceber que personagens ela misturou?</p></li>\
                                            </ul>\
                                            \
                                        </div>\
                                    </div>',
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                            <h2><strong style="font-size:inherit;">ANTES DA LEITURA</strong></h2>\
                                            <h4><span style="font-size:inherit;">Na página 4 estão os nomes de outras pessoas que trabalharam para que a história se tornasse um livro.</span></h4>\
                                            <h4 style="margin-left:20px;"><span style="font-size:inherit;">Na página 5, a história começa.</span></h4>\
                                            <ul style="margin-left:30px;">\
                                                <li><div></div><p>Apresente às crianças a Vovó Neném. Deixe que observem sua casinha, os passarinhos, o balão de fala com um assobio.</p></li>\
                                                <li><div></div><p>Ela parece uma pessoa alegre ou triste? Quem conhece alguém parecido com a vovó Neném?</p></li>\
                                                <li><div></div><p>Vamos ler a história da Vovó Neném?</p></li>\
                                                <li><div></div><p>Combine com as crianças que vocês vão ler a história toda e depois vão ter um espaço de tempo para conversar sobre ela.</p></li>\
                                                \
                                            </ul>\
                                            \
                                        </div>\
                            ...
                            carouselItens: [
                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                           <h2><strong style="font-size:inherit;">DURANTE A LEITURA</strong></h2>\
                                            \
                                            <ul>\
                                                <li><div></div><p>Comece a ler, buscando usar a entonação correta para as falas e expressar as emoções que o texto contém.</p></li>\
                                                <li><div></div><p>Pare em alguns momentos para mostrar as imagens e checar se sua audiência está atenta.</p></li>\
                                                \
                                            </ul>\
                                        </div>\
                                    </div>',
                                ...
                                },
                                {
                                    ...
                                    <div class="content vertical-align">\
                                        \
                                        <div class="scroll mCustomScrollbar">\
                                        <h2><strong>DEPOIS DA LEITURA</strong></h2>\
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                            ...
                                            <ul>\
                                                <li><div></div><p>O uso de balões de fala no decorrer do texto. Seus alunos conseguem identificar que eles representam falas?</p></li>\
                                                <li><div></div><p>Onde costumamos encontrar esses balões?*</p></li>\
                                                \
                                            </ul>\
                                            <p class="small-text">*Em histórias em quadrinhos.</p>\
                                            </div>\
                                        </div>\
                                    </div>',
                                    itemNavigation: {
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                            <h2><strong style="font-size:inherit;">DEPOIS DA LEITURA</strong></h2>\
                                            <div class="separator-colum">\
                                            <div style="width:72%; margin-right:40px;">\
                                            <h4><span>Nas páginas 8 e 9.</span></h4>\
                                            <ul>\
                                                <li><div></div><p>As crianças podem querer reconhecer e comentar as brincadeiras que aparecem ali. Alguém conhece alguma delas?</p></li>\
                                            </ul>\
                                            \
                                            <h4><span>Nas páginas 10 a 13.</span></h4>\
                                            <ul>\
                                                <li><div></div><p>Vovó Neném gostava de misturar histórias. Que histórias ela misturou? Alguém conhece essas histórias?</p></li>\
                                                <li><div></div><p>Se a sua turma for conhecedora de contos de fadas, eles vão adorar encontrar essas contradições.</p></li>\
                                            </ul>\
                                            </div>\
                                            \
                                            <div style="width:50%;">\
                                            ...
                                            <ul>\
                                                <li><div></div><p>Como é uma festa de bonecas?</p></li>\
                                                <li><div></div><p>Por que Mariana estava triste?</p></li>\
                                            </ul>\
                                            \
                                            <h4><span>Nas páginas 20 a 23.</span></h4>\
                                            <ul>\
                                                <li><div></div><p>Observaram a fala da Vovó Neném na página 21? O que será que ela quis dizer?</p></li>\
                                                <li><div></div><p>Ela consegue ajudar a Mariana?</p></li>\
                                            </ul>\
                                            </div></div>\
                                            \
                                        </div>\
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                       ...
                                       \
                                        <div class="separator-colum">\
                                        <div style="width: 54%; margin-right:27px;">\
                                        <h4><span>Nas páginas 24 a 29.</span></h4>\
                                        <ul>\
                                            <li><div></div><p>Como ficou a boneca?</p></li>\
                                        </ul>\
                                        \
                                        <h4><span>Nas páginas 30 a 35.</span></h4>\
                                        <ul>\
                                            <li><div></div><p>Quem pediu para o Beto consertar o carrinho de boneca de Mariana?*</p></li>\
                                        </ul>\
                                        <p class="small-text">*Algumas crianças podem não perceber imediatamente que aquilo foi uma surpresa da Vovó Neném.</p>\
                                        </div>\
                                        \
                                        <div style="width:100%; margin-right:40px;">\
                                        <h4><span>Nas páginas 36 e 37.</span></h4>\
                                        <ul>\
                                            <li><div></div><p>Por que Mariana deu à sua boneca o nome de Cinderela?</p></li>\
                                            <li><div></div><p>Vocês descobriram por que o livro se chama <strong><em>A Cinderela das bonecas?</em></strong></p></li>\
                                            <li><div></div><p>Finalmente, mostre a todos a imagem da página 38 e faça-os notar que ali está escrito FIM.</p></li>\
                                            <li><div></div><p>Em conjunto com seus alunos, recapitule a história inteira, para ver se ficaram lacunas na compreensão.</p></li>\
                                            <li><div></div><p>Se só você tiver o livro em mãos, passe-o pela turma, para que eles possam observar as ilustrações de perto.</p></li>\
                                        </ul>\
                                        \
                                        \
                                       \
                                        </div></div>\
                                        <p class="small-text" style="text-align:center;">Você encontra mais sugestões de atividades com este livro no site da editora. Acesse pelo link:</p>\
                                        \
                                        </div>\
                                    </div>',
                                    itemNavigation: {
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                        <h2><strong>SUGESTÃO PARA LEITURA PELOS PRÓPRIOS ALUNOS</strong></h2>\
                                       \
                    ...
                    pageCarousels: [
                        {
                            ...
                            carouselItens: [
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                            <h2><strong>ANTES DA LEITURA</strong></h2>\
                                            <div style="margin-left:30px;"><h5><strong style="inherit">Converse com seus alunos, mostre a capa do livro, e incentive-os a fazer antecipações.</strong></h5>\
                                            <ul>\
                                                <li><div></div><p>Da forma como os nomes dos autores aparecem na capa, é possível saber que escreveu o texto e quem fez as ilustrações?*</p></li>\
                                                <li><div></div><p>Será que seus alunos já conhecem essa dupla de autores? Já leram algum livro deles?</p></li>\
                                                \
                                                <li><div></div><p>A capa tem um recorte que imita uma janela. Por que será? De que janela será que a história fala?</p></li>\
                                                \
                                                <li><div></div><p>Quem será essa menina que parece na janelinha da capa?</p></li>\
                                                <li><div></div><p>Onde está o logotipo da editora?</p></li>\
                                                \
                                                <li><div></div><p>Leia a quarta capa em voz alta: por que será que é estranha assim?**</p></li>\
                                            </ul>\
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                            <h2><strong style="font-size:inherit;">DURANTE A LEITURA</strong></h2>\
                                            <div style="margin-left:30px;"><div class="separator-colum">\
                                            <div style="margin-right:24px;">\
                                            <h5>Observe (e ajude seus alunos a observar) a primeira página do livro.</h5>\
                                            <ul>\
                                                <li><div></div><p>A menina que aparece na capa está mesmo numa janela.</p></li>\
                                            </ul>\
                                            \
                                            <h5>Na página 2 estão os nomes de outras pessoas que trabalharam para que a história se tornasse um livro.</h5>\
                                            <h5>Mostre a eles a página 3.</h5>\
                                            <ul>\
                                                <li><div></div><p>O que aparece nesta ilustração? Por que será que tem um dente pulando, correndo?</p></li>\
                                                <li><div></div><p>Explique que esta página, que se chama “frontispício” ou “página de rosto” do livro, repete quase todas as informações da capa. É aí que o livro começa.</p></li>\
                                            </ul>\
                                            </div>\
                                            \
                                            <div>\
                                            <h5>Na página 4, a história começa.</h5>\
                                            <ul>\
                                                <li><div></div><p>Leia a primeira frase e mostre a ilustração de Maria Fernanda.</p></li>\
                                                <li><div></div><p>Vamos saber o que aconteceu com ela?</p></li>\
                                            \
                                                <li><div></div><p>Combine com as crianças que vocês vão ler a história toda e depois vão ter um espaço de tempo para conversar sobre ela.</p></li>\
                                                <li><div></div><p>Comece a ler, buscando usar a entonação correta para as falas e expressar as emoções que o texto contém.</p></li>\
                                            </ul></div>\
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        ...
                                        <h2><strong style="font-size:inherit;">DEPOIS DA LEITURA</strong></h2>\
                                        <div style="margin-left:30px;">\
                                        <h5>Aqui vão algumas sugestões de perguntas para iniciar a roda de leitores:<h5>\
                                        <ul>\
                                            <li><div></div><p>Vocês entenderam o que aconteceu com a Maria Fernanda?</p></li>\
                                            <li><div></div><p>Vocês se lembram quando caiu seu primeiro dente? Como se sentiram?</p></li>\
                                            \
                                            <li><div></div><p>Vamos ver o que aconteceu na cabeça da Maria Fernanda?</p></li>\
                                        </ul>\
                                        \
                                        <p><strong>Observe que livro quase todo apresenta uma página de texto “espelhada” com uma de ilustração. Em quase todas as ilustrações há alguma coisa importante a notar para compreender o que se passa na cabeça de Maria Fernanda:</strong>\
                                        </p>\
                                        </div>\
                                        </div>\
                                    </div>',
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        ...
                                        <h2><strong style="font-size:inherit;">DEPOIS DA LEITURA</strong></h2>\
                                        <div style="margin-left:30px;"><div class="separator-colum">\
                                        <div style="margin-right:30px; width:75%;">\
                                        <h4><span>Página 7:</span></h4>\
                                        <ul>\
                                            <li><div></div><p>Chame a atenção para a mão da mãe, aparando o dente que caiu. O que será que isso quer dizer?</p></li>\
                                            <li><div></div><p>Por que há uma mamadeira caindo também?</p></li>\
                                        </ul>\
                                        \
                                        <h4><span>Páginas 12 a 27:</span></h4>\
                                        <ul>\
                                            <li><div></div><p>Repasse com eles o texto e a ilustração dessas páginas, para conferir se acompanharam a confusão que aconteceu na cabeça da menina.</p></li>\
                                        </ul>\
                                        </div>\
                                        \
                                        <div style="margin-right:20px; width:80%;">\
                                        <h4><span>A partir da página 28:</span></h4>\
                                        <ul>\
                                            <li><div></div><p>O que Maria Fernanda começou a achar?</p></li>\
                                            <li><div></div><p>O que aconteceu com Maria Fernanda então? A ideia dela deu certo?</p></li>\
                                            <li><div></div><p>Como a história termina?</p></li>\
                                            \
                                            <p>Assim que se certificar de que todos compreenderam a narrativa, lance a pergunta:</p>\
                                            <li><div></div><p>O que vocês acham: a gente pode falar tudo aquilo que vem em nossa cabeça?</p></li>\
                                        </ul></div>\
                                        </div></div>\
                                        </div>\
                                    </div>',
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                            ...
                                            \
                                            <h3><strong>Página 1:<strong></h3>\
                                            \
                                            <ul>\
                                            <li><div></div><p>Observe que a página mostra unicamente uma macieira. O que teria ela a ver com o buraco que Sam e Dave cavaram?</p></li>\
                                            \
                                            <li><div></div><p>Nas páginas 3 e 4, os dois estão saindo de uma casa que tem um catavento em forma de galo. Na varanda, há um vaso com uma tulipa e, sentado no degrau, um gato de coleira laranja os observa partir. Lá está de novo a macieira. É ao lado dela que os dois vão cavar seu buraco.</p></li>\
                                            \
                                            <li><div></div><p>No decorrer do texto, a narrativa segue, aparentemente alheia ao que acontece nas ilustrações. Chame a atenção de seus alunos para isso: apesar de estarem sempre tão perto de diamantes e nem eles nem o narrador parecem perceber nada.</p></li>\
                                            \
                                            <li><div></div><p>Observe, na página 40, a forma criativa como o texto e a ilustração representam a queda dos três.</p></li>\
                                            \
                                            <li><div></div><p>Finalmente, observe as páginas finais: eles voltaram mesmo para casa? Onde está a macieira? E a flor, o gato e o cata-vento são os mesmos da casa original?</p></li>\
                                            \
                                            <li><div></div><p>Será que aconteceu algo muito especial com Sam e Dave e eles nem perceberam?</p></li>\
                                            \
                                            <li><div></div><p>Terminada a leitura, caso só você disponha do livro, passe pela turma inteira para que eles possam apreciar as ilustrações e fazer comentários ou perguntas. Se todos os alunos dispuserem de um exemplar, ou mesmo se houver exemplares suficientes para leituras em grupo, incentive-os a fazer mais uma leitura do livro, agora por conta própria. Enquanto isso, você vai passando pelas crianças, ajudando-as quando for preciso.</p></li>\
                                        </ul>\
                                            \
                            ...
                            carouselItens: [
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        ...
                                        \
                                        <div style="margin-left:30px;"><ul>\
                                            <li><div></div><p>Leia o sumário e ajude os alunos a recuperar os conhecimentos que já têm sobre cada conto. </p></li>\
                                            \
                                            <li><div></div><p>Como se trata de histórias tradicionais, pode ser que seus alunos já conheçam muitas delas. Mas você pode apresentar as desconhecidas para eles e, em seguida, pedir que escolham no Sumário (ver abaixo) a história que querem que você leia.</p></li>\
                                            <li><div></div><p>No caso de 1º a 3º anos, peça a um aluno para encontrar no sumário o nome do conto e a página onde se encontra; depois, peça-lhe para mostrar a todos onde encontrou. </p></li>\
                                            <li><div></div><p>Ler as quartas capas para se informar sobre o livro e saber utilizar o sumário são procedimentos leitores muito importantes! </p></li>\
                                        </ul>\
                                        \
                                        <div class="content-img">\
                                            <div class="image"></div>\
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                        <h3><span>DURANTE A LEITURA </span></h3>\
                                        <h4><span>Para 1º a 3º ano</span></h4>\
                                        <div style="margin-left:30px;"><h4>Para os alunos ainda não totalmente alfabetizados, você pode ler um conto em voz alta.</h4>\
                                        \
                                        <ul>\
                                            <li><div></div><p>Leia a narração com a entonação adequada, para que seus alunos percebam a diferença entre a voz do narrador e os diálogos. </p></li>\
                                            \
                                            <li><div></div><p>Durante a leitura, observe os alunos, para ver se estão acompanhando o que você lê. Se estiverem com o livro em mãos, peça-lhes para marcarem a lápis as palavras que não conhecem.</p></li>\
                                            <li><div></div><p>Se não estiverem, pare nos momentos em que encontrar palavras difíceis – como já vimos – só em situações que o não conhecimento de seu significado possa dificultar a compreensão do conto. Explique a eles que na roda de leitores as palavras desconhecidas serão esclarecidas.</p></li>\
                                        </ul>\
                                        </div>\
                                        </div>\
                                    </div>',
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        ...
                                        \
                                        <ul>\
                                            <li><div></div><p>Durante a roda de leitores, ajude-os a recapitular cada passagem do conto. </p></li>\
                                            \
                                            <li><div></div><p>Esclareça o que não foi compreendido e releia trechos, se for necessário, esclarecendo o sentido das palavras desconhecidas.</p></li>\
                                            <li><div></div><p>Ajude-os a perceber, nos próprios contos, os momentos em que o narrador que reconta as histórias interfere, dando informações ou sua opinião sobre alguma passagem. Por exemplo, na página 136, sobre a ideia dos pais de João e Maria de abandoná-los à própria soret: <em>“Francamente, não era uma ideia muito maternal. Onde já se viu a própria mãe querer abandonar os filhos na floresta?”</em>.</p></li>\
                                            \
                                            <li><div></div><p>Ao final, peça a opinião das crianças sobre o conto. O que acharam das interferências do narrador?</p></li>\
                                            <li><div></div><p>É importante desenvolver esse tipo de discussão, para que eles se tornem cada vez mais leitores críticos.</p></li>\
                                            <li><div></div><p>Após a conversa, você pode recapitular oralmente os principais eventos do conto. Pode também ir registrando no quadro a sequência de acontecimentos, caso queira trabalhar com ela numa atividade de reescrita.</p></li>\
                                        </ul>\
                                            \
                                        </div>\
                                    </div>',
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                       ...
                                       <div style="margin-left:30px;"> <p>Para os alunos ainda não totalmente alfabetizados, você pode ler um conto em voz alta.</p>\
                                        \
                                        <ul>\
                                            <li><div></div><p>Comece com os procedimentos normais para antes e durante a leitura. </p></li>\
                                            \
                                            <li><div></div><p>Ao final, porém, após a roda de leitores, caso haja livros suficientes, você pode pedir para cada aluno escolher um outro conto e lê-lo silenciosamente para um outro dia em que houver roda de histórias.</p></li>\
                                            <li><div></div><p>Nesse dia, cada aluno relata para os colegas o conto que leu (no caso de dois ou mais escolherem o mesmo, eles dividem o relato).</p></li>\
                                            \
                                            <li><div></div><p>Ao final, na roda de leitores, todos discutem os contos lidos.</p></li>\
                                        </ul>\
                                            \
                                            <p>Você encontra mais sugestões de atividades para antes, durante e depois da leitura no site da editora. </p>\
                                            <p>Acesse pelo link:</p></div>\
                                        </div>\
                                    </div>',
                                    itemNavigation: {
                                        navCustomClass: '',
                            ...
                            carouselItens: [
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                            \
                                            <p>Você encontra as sugestões completas de atividades no site da editora. </p>\
                                            \
                                            <p>Acesse pelo link:</p>\
                                            \
                                            <ul>\
                                                <li><div></div><p>As atividades apresentadas no site são bem completas, e abrangem as três fases sugeridas por Isabel Solé.</p></li>\
                                                \
                                                <li><div></div><p>Apenas para complementar, sugerimos que você comece lendo o primeiro capítulo e, em seguida, deixe que um aluno leia o segundo, outro o terceiro, assim consecutivamente, mesmo que não realize toda a leitura no mesmo dia.</p></li>\
                                                \
                                                <li><div></div><p>Você pode também ler um capítulo na hora do conto e pedir aos alunos que leiam alguns capítulos em casa.</p></li>\
                                                \
                                                <li><div></div><p>Nesse caso – ou no caso de o livro ser lido em diferentes dias – comece a atividade recapitulando oralmente os eventos dos capítulos anteriores.</p></li>\
                                                \
                                                <li><div></div><p>E, finalmente, não se esqueça de explorar bem o Sumário, ensinando seus alunos a usá-lo adequadamente, assim como o <em style="color:#EDEB64;">marcador de livros.</em></p></li>\
                                            </ul>\
                                            \
                                        </div>\
                                    </div>',
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        ...
                                        <h3><span>ANTES DA LEITURA </span></h3>\
                                        \
                                        <h4><span>Prepare-se para apresentar o livro. </span></h4>\
                                        <ul>\
                                            <li><div></div><p>Comece buscando informações relevantes sobre o livro e o autor. No link abaixo, você encontra, no site da editora, um material com informações sobre o autor, a obra e sugestões de trabalho:</p></li>\
                                        </ul>\
                                        \
                                        <h3><span>DURANTE A LEITURA</span></h3>\
                                        \
                                        <p>O encarte tem sugestões detalhadas de como apresentar o livro e para como <em style="color:#EDEB64;">atuar durante</em> a leitura.</p>\
                                        \
                                        </div>\
                                    </div>',
                                    itemNavigation: {
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                        <h3><span>DEPOIS DA LEITURA </span></h3>\
                                        <p style="margin-left:30px;">É para este momento que gostaríamos de detalhar alguns outros elementos que você pode colocar em discussão com seus alunos após a leitura de cada capítulo, deixando as perguntas mais generalizantes sugeridas pelo encarte para o final da leitura do livro todo.</p>\
                                        \
                                        </div>\
                                    </div>',
                                    itemNavigation: {
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        ...
                                        \
                                        <div class="image"></div>\
                                            <ul style="width:70%; margin-right:20px;">\
                                                <li><div></div><p>Nesse sentido, releia com eles o trecho que fala sobre o “mapa da cabeça de uma criança”. Você pode mostrar para seus alunos um exemplo como este:</p></li>\
                                                \
                                                <li><div></div><p>Observando um mapa assim, fica muito mais fácil transformar em imagens as palavras de Barrie, nas páginas 14 e 15:</p></li>\
                                                \
                                                <li><div></div><p>Ao final, na roda de leitores, todos discutem os contos lidos.</p></li>\
                                            </ul>\
                                                \
                                        ...
                                        \
                                            \
                                            <div style="border:1px solid #fff; padding:0 12px; "><p>“(…) Mas eles nunca se metem a desenhar a mente de uma criança. Não só porque é muito confusa, mas porque ela fica girando sem parar. É cheia de linhas em ziguezague, parecidas com os gráficos de temperatura. Provavelmente essas linhas são estradas da ilha. Ah, sim, porque a Terra do Nunca é, sempre, mais ou menos uma ilha, com manchas surpreendentes de cores aqui e ali (…)”</p></div>\
                                            \
                                            \
                                        <ul>\
                                            <li><div></div><p>Este capítulo é fundamental para conquistar seus alunos para a leitura do livro. Se eles se deixarem levar pela atmosfera de fantasia criada por Barrie vão se encantar e mergulhar no mundo das personagens da Terra do nunca.</p></li>\
                                        </ul>\
                                            \
                                        </div>\
                                    </div>',
                                ...
                                },
                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                        <h4><strong>Observações sobre outros capítulos  </strong></h4>\
                                        \
                                        \
                                        <ul>\
                                            <li><div></div><p>Até o capítulo IV a narrativa flui bem. Você pode parar nos momentos em que encontrar algum elemento do texto para destacar, ou nas divertidas intervenções do narrador, como na página 59, em que ele garante aos leitores que “no final tudo vai dar certo e acabar bem”.</p></li>\
                                            \
                                            <li><div></div><p>O capítulo IV, porém, vai exigir de você um pouco mais de discussão, pois Peter fica sumindo e reaparecendo, e isso pode ser um pouco monótono para os leitores. Explique a eles que o escritor fez isso de propósito, para criar também nos leitores essa atmosfera sonolenta, que é o que “nos carrega” todos para a Terra do Nunca.</p></li>\
                                            \
                                            <li><div></div><p>No capítulo V, a destacar, a apresentação que Barrie faz dos personagens da ilha andando uns atrás dos outros. Essa cena tem um poder descritivo tão forte que é como se estivéssemos vendo a cena. Lembre-se que Peter Pan foi, antes de ser livro, uma peça de teatro. Essa força para criar imagens aparece em vários momentos. Você pode parar e explorar cada um deles com seus alunos, pois os recursos utilizados pelo escritor são muito ricos e darão a seus alunos exemplo muito interessantes do uso da linguagem literária.</p></li>\
                                            \
                                            <li><div></div><p>No mais, curta com eles a leitura desse clássico, que pode durar algumas semana, por se tratar de texto bem mais complexo que o reconto.</p></li>\
                                            \
                                        </ul>\
                                            \
                                        </div>\
                            ...
                            carouselItens: [
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                            \
                                            <h3><span>Para 1º e 2º anos</span></h3>\
                                            <h4>Livros com jogos de palavras:</h4>\
                                           \
                                            \
                                            <div class="content-image">\
                                            \
...

                                {
                                    ...
                                    <div class="scroll mCustomScrollbar">\
                                        \
                                        <h3><span>Para 1º e 2º anos</span></h3>\
                                        <h4>Narrativas escritas em quadrinhas:</h4>\
                                       \
                                        \
                                        <div class="content-image">\
                                        \
...

                                {
                                    ...
                                    <div class="content vertical-align">\
                                        <div class="scroll mCustomScrollbar">\
                                            \
                                            <h3><span>Para 1º e 2º anos</span></h3>\
                                            <h4>Adivinhas, trava-línguas, parlendas e trovas:</h4>\
                                           \
                                            \
                                            <div class="content-image">\
                                            \
